...
| **Provenance a regulated firm can audit** | Content-hashed questions, append-only runs, contamination canaries, and every score kept next to the raw output it came from. | [auslawexam&#8209;bench](https://github.com/Danielkgr/auslawexam-bench) |
